...
public class PaymentResource {
    ...
    @GetMapping("/payments/loginUser/{login}")
    public ResponseEntity<List<PaymentDTO>> findAllPaymentsByLoginUser(@PathVariable String login) {
        log.debug("REST request to get a page of payments by UserLogin");
        List<PaymentDTO> list = paymentService.findAllPaymentsByLoginUser(login);
