...
export class BeneficiaryService {
  ...
  getAllByLogin(login: string): Observable<EntityArrayResponseType> {
    return this.http.get<IBeneficiary[]>(`${this.resourceUrl}/loginUser-withoutPage/${login}`, { observe: 'response' });
  }
